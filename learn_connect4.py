...
def generate_supervised_training_data(num_episodes, time_limit=0.5, directory_name='/media/beomjoon/My Passport/vision_project/supervised_data/train_data'):
  train_data= []
  for x in xrange(num_episodes): 
    ...
    sio.savemat(directory_name + str(x)+'.mat',{'winner_train_data':winner_train_data,'loser_train_data':loser_train_data,\
